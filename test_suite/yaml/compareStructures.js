...
// Additional challenges when using a library is the collections config in
// _config.yml - its children's names can be anything - and nothing out
...
module.exports = {
  compareStructures(structureDefinition, subject) {
    // run 1 pass through definition, check that required fields are
    // there, and required values match
