...
const userFriendlyErrorMessages = {
	...
	MD007: " should have its nested list begin with an extra 4 spaces before the asterisk (`*`)",
	...
	MD029: " has list prefixes that are not increasing in order (e.g. 1. 2. 4. 5.) and the resulting generated numbering might not be what you were expecting. If you were trying to continue a previous list after a chunk of text, add 4 spaces to the front of each line in the chunk of text.",
	...
	MD039: " has spaces inside link texts (e.g. `[ There is a space before and after me ](https://www.example.com)`) We suggest removing these ",
